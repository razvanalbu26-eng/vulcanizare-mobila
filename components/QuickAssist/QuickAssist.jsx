...
export default function QuickAssist() {
  ...
  // 📞 popover telefoane (ca în Header)
  ...
  const waText = useMemo(() => {
    const parts = [
      ...
      mode === "gps"
        ...
        : `Poziție estimată: ${roadType} · ${direction} · aprox. km ${km}${
            reper ? ` · Reper: ${reper}` : ""
          }.`,
      mode === "manual"
        ? `ETA estimativ: ~${etaMin} min (în funcție de trafic).`
        : null,
  ...
  function getLocation() {
    ...
    if (!navigator.geolocation) {
      setErr(
        "Browser-ul nu suportă locația. Alege „Fără GPS” și completează km + reper."
      );
      return;
    }
    setLoading(true);
    navigator.geolocation.getCurrentPosition(
      ...
      (e) => {
        ...
        if (e?.code === 1) {
          setErr(
            "Locația e blocată. Permite Location din setările site-ului și reîncarcă."
          );
        } else {
          setErr(
            "Nu am putut prelua locația. Încearcă din nou sau folosește modul „Fără GPS”."
          );
        }
      },
      ...
      <header className={styles.header}>
        <div className={styles.titleWrap}>
          ...
          <p className={styles.sub}>
            Alegi metoda (GPS / fără GPS), completezi detaliile și trimiți direct
            pe WhatsApp.
          </p>
        </div>
        ...
        <aside className={styles.side}>
          <div className={styles.sideCard}>
            ...
            <ul className={styles.steps}>
              <li>
                <span className={styles.stepNum}>1</span> Confirmare rapidă pe
                WhatsApp / telefon
              </li>
              <li>
                <span className={styles.stepNum}>2</span> Reper + poză (dacă e
                cazul) pentru identificare
              </li>
              <li>
                <span className={styles.stepNum}>3</span> Plecăm și îți comunicăm
                ETA actualizat
              </li>
            </ul>
          </div>
            ...
            <div className={styles.mini}>
              ...
              <div>
                ...
                <div className={styles.miniValue}>
                  {SITE.highwayRadiusKm ?? 120} km
                </div>
              </div>
            </div>
            <div className={styles.note}>
              Pe autostradă putem acoperi distanțe mai mari datorită vitezei
              constante. În oraș/DN, timpul poate varia.
            </div>
          </div>
        </aside>
        ...
        <div className={styles.form}>
          ...
          {mode === "gps" ? (
            <div className={styles.panel}>
              <div className={styles.panelHead}>
                <div>
                  <div className={styles.panelTitle}>
                    Trimite locația automată
                  </div>
                  <div className={styles.panelSub}>
                    Recomandat dacă ești pe A7 / E85 și ai semnal bun.
                  </div>
                </div>
                <button
                  type="button"
              ...
              {loc ? (
                ...
                <div className={styles.hint}>
                  Dacă nu merge, treci pe “Fără GPS” și pune tip drum + km +
                  sens.
                </div>
              )}
            </div>
            ...
            <div className={styles.panel}>
              <div className={styles.panelHead}>
                <div>
                  <div className={styles.panelTitle}>
                    Estimare pe tip drum + km
                  </div>
                  <div className={styles.panelSub}>
                    Autostrada permite distanțe mai mari. ETA este orientativ.
                  </div>
                </div>
              ...
              <div className={styles.row}>
                ...
                <div className={styles.hint}>
                  Tip: Reperul ajută mult (ex: “km 52, parcare dreapta”, “ieșire
                  X”, “OMV”). Pe autostradă acoperirea e mai mare.
                </div>
              </div>
            </div>
          )}
          ...
          <div className={styles.cta}>
            ...
            <div ref={phoneWrapRef} className={styles.phoneWrap}>
              ...
              {phoneMenuOpen && (
                <div className={styles.phoneMenu} role="menu" aria-label="Alege numărul de telefon">
                  {SITE?.phone1 && (
                    <a
                      role="menuitem"
                  ...
                  {/* fallback dacă nu ai phone1/phone2 dar ai SITE.phone */}
                  {!SITE?.phone1 && !SITE?.phone2 && SITE?.phone && (
                    <a
                      role="menuitem"
                      href={`tel:${SITE.phone}`}
                      onClick={() => setPhoneMenuOpen(false)}
